...
%   \item \textbf{编程语言}：Python > C > C++ > Java
%   \item \textbf{平台框架}：PyTorch, Latex, VSCode, Linux/Git
%   \item \textbf{研究兴趣}：
%     \begin{itemize}
%       \item 大模型压缩：结构化剪枝、知识蒸馏、低比特量化
%       \item 推理加速：KV缓存优化、隐式CoT推理、轻量化部署
%     \end{itemize}
%   % \item \textbf{其他技能}：技术文档写作（ACL论文在投）、英文文献阅读（CET-6）、Kaggle竞赛经历
% \end{itemize}
...
%     \item \textbf{编程语言}: Python > Shell > C/C++ > Java
%   \end{itemize}
%   &
%   % \textbf{平台框架}: 
%   \begin{itemize}[nosep,leftmargin=*,topsep=0pt]
%     \item \textbf{平台框架}: PyTorch, LaTeX, Linux/Git, VSCode
%   \end{itemize}
% \end{tabularx}
% \vspace{-1em} % 调整垂直间距
% \begin{itemize}[parsep=0.5ex]
%   \item \textbf{研究兴趣}:
%     \begin{itemize}
%       \item 大模型压缩：结构化剪枝、知识蒸馏、动态量化、轻量化部署
%       \item 推理加速：KV缓存优化、隐式CoT推理、并行解码策略
%     \end{itemize}
% \end{itemize}
